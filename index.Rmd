...
Looking at the regressions generated it is clear that the best indicators of buckthorn's presence are compaction, clay, slope, and pH. However, of those predictors the most significant were compaction and slope as they contained p-values less than .05 (0.0446 and .0387 respectively). Additionally, the best variables determining relative abundance within sites were non-forested area, canopy coverage, and temperature. 

## Buckthorn SDM
In the current state of the model no conclusion can be drawn due to the model only including temperature and precipitation as variables for habitat suitability. 
